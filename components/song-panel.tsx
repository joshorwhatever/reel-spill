            ...
            <div className="flex flex-col gap-1 flex-1 min-h-0">
              ...
              <div className="relative flex-1 min-h-0 border border-border bg-black focus-within:border-cream/60 overflow-hidden">
                {isBulkEditing ? (
                  ...
                  <div className="w-full h-full overflow-y-auto p-1 flex flex-col gap-0.5">
                    {lyricLines.map((line, idx) => {
                        ...
                        return (
                          <div key={idx} className="flex items-center py-0.5">
                            <input
                              ...
                              className="w-full bg-white/10 text-white font-mono text-xs px-1.5 py-0.5 focus:outline-none border border-cream/60 rounded-xs"
                            />
                          </div>
                        )
                      }
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center gap-1.5 px-1.5 py-0.5 rounded transition-colors select-none cursor-grab active:cursor-grabbing hover:bg-white/10 border border-transparent hover:border-white/20 group"
